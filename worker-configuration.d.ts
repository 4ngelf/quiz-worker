/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f38f1c30790c56b70bb7e29f449eafbe)
    ...
    [K in keyof MainModule]:
      ...
      & (K extends GlobalProp<"durableNamespaces", never>
        ? MainModule[K] extends new (...args: any[]) => infer DoInstance
          ? DoInstance extends Rpc.DurableObjectBranded ? DurableObjectNamespace<DoInstance>
